...
export default function AuthPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sent = await sendOtpToEmail(cleanEmail, name.trim(), code);

      if (!sent) {
        toast.error("Gagal mengirim OTP ke Gmail. Cek EmailJS.");
        return;
      }
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      if (!sent) {
        toast.error("Gagal kirim ulang OTP. Cek EmailJS.");
        return;
      }
